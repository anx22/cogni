  ...
  return (
    <section className="relative px-8 md:px-12 lg:px-16 xl:px-20 pt-16 pb-12 bg-surface-1 border-b border-border-strong">
      ...
      <div className="relative max-w-6xl mx-auto space-y-7">
        ...
        <div className="rounded-2xl border border-border-subtle bg-surface-2 shadow-card-glow p-6">
          <p className="text-[11px] uppercase tracking-[0.2em] text-muted-foreground/70 mb-2.5">Lagebild</p>
          <p className="text-base text-foreground/95 leading-relaxed">{project.lagetext}</p>
        </div>
        ...
        {project.outcome && (
          <div className="rounded-xl border border-border-subtle bg-surface-2 shadow-card-glow px-5 py-4">
            ...
            <p className="text-sm text-foreground/90 leading-relaxed mb-2">{project.outcome.erfolgskriterium}</p>
