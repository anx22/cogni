  ...
  return (
    <header className="dlg2-header">
      <div style={{ display: "flex", alignItems: "center", gap: 14, fontSize: 13 }}>
        ...
        <span
          style={{ fontFamily: "Geist Mono, monospace", color: "var(--d-ink-2)", fontSize: 12 }}
        >
          {source}
        </span>
        {summary && (
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
        <span
          style={{ fontFamily: "Geist Mono, monospace", fontSize: 12, color: "var(--d-ink-3)" }}
        >
          {current} / {total}
        </span>
...
/* ============================================================
   Row Renderers
   ============================================================ */
function RowAccepted({
  type,
  content,
  sub,
  project,
  typeColor = "rgba(255,255,255,.06)",
  typeTextColor = "var(--d-ink-3)",
}) {
  return (
    <div className="dlg2-row">
      ...
      {/* Type */}
      <span className="dlg2-type" style={{ background: typeColor, color: typeTextColor }}>
        {type}
      </span>
      {/* Content */}
      <span
  ...
  return (
    <>
      <div className="dlg2-row" style={{ minHeight: 52 }}>
        ...
        <span
          className="dlg2-type"
          style={{ background: "var(--d-warn-soft)", color: "var(--d-warn)" }}
        >
          Konflikt
        </span>
        {/* content */}
        ...
        <div style={{ display: "flex", gap: 6, marginLeft: 12, flex: "0 0 auto" }}>
          ...
          <button className={`dlg2-chip-opt`} style={{ color: "var(--d-ink-4)" }}>
            offen lassen
          </button>
        </div>
        <button
        ...
        <div className="dlg2-expand">
          <div style={{ display: "flex", gap: 12, alignItems: "stretch" }}>
            ...
            >
              ...
              <div
                style={{
                  ...
                  fontWeight: 500,
                  letterSpacing: "-.02em",
                  color: chosen === 0 ? "var(--d-warn)" : "var(--d-ink-2)",
                }}
              >
                15. Mai 2026
              </div>
            ...
            >
              ...
              >
                Quelle B — Steering-Protokoll v3
              </div>
              <div
                style={{
                  fontSize: 22,
                  fontWeight: 500,
                  letterSpacing: "-.02em",
                  color: chosen === 1 ? "var(--d-warn)" : "var(--d-ink-2)",
                }}
              >
                1. Juni 2026
              </div>
              ...
              >
                12.04.2026 · Seite 3 · formell
              </div>
            </div>
          </div>
          <div style={{ marginTop: 10, fontSize: 12, color: "var(--d-ink-3)" }}>
            cogni empfiehlt <span style={{ color: "var(--d-warn)" }}>15. Mai</span> — jüngere
            direkte Aussage des PM. Klick zum Überschreiben.
          </div>
        </div>
      )}
    </>
  ...
  return (
    <>
      <div className="dlg2-row" style={{ minHeight: 52 }}>
        ...
        >
          Latenzziel fehlt
          <span style={{ color: "var(--d-ink-3)", marginLeft: 8, fontSize: 12 }}>
            → blockiert API-Architektur
          </span>
        </span>
        {inputVisible ? (
          ...
          <button
            className="dlg2-chip-opt"
            style={{ flex: "0 0 auto", borderColor: "var(--d-warn)", color: "var(--d-warn)" }}
          >
            Eingeben
          </button>
        )}
...
function RowReady({ type, content, project }) {
  return (
    <div className="dlg2-row">
      <div className="dlg2-stripe" style={{ background: "var(--d-ok)", opacity: 0.7 }} />
      <span
        style={{
          width: 16,
          height: 16,
      ...
      <span className="dlg2-type" style={{ background: "var(--d-ok-soft)", color: "var(--d-ok)" }}>
        {type}
      </span>
      <span
        style={{
  ...
  return (
    <div className="dlg2-root">
      ...
      <div className="dlg2-list">
        ...
        <RowAccepted
          type="Entscheidung"
          content="Timeline um 2 Wochen verschoben"
          project="Hafen Nord"
        />
        <RowConflict expanded={false} chosen={0} />
        <RowAccepted
          type="Stakeholder"
          content="Maria Schulz · Projektsteuerung"
          project="Hafen Nord"
        />
        <RowGap inputVisible={false} />
        <RowAccepted
          type="Entscheidung"
          content="React als Frontend-Framework"
          project="Hafen Nord"
        />
      ...
      <div className="dlg2-commitbar">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <button className="dlg2-btn-commit">
            5 übernehmen
            <span style={{ opacity: 0.5, fontSize: 12, fontFamily: "Geist Mono, monospace" }}>
              ↵
            </span>
          </button>
        </div>
      ...
      <div className="dlg2-commitbar">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <button className="dlg2-btn-commit ready">
            Alles übernehmen →
            <span style={{ opacity: 0.55, fontSize: 12, fontFamily: "Geist Mono, monospace" }}>
              ↵
            </span>
          </button>
        </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        {source && (
          <span
            style={{ fontFamily: "Geist Mono, monospace", fontSize: 11, color: "var(--d-ink-3)" }}
          >
            {source}
          </span>
        )}
      ...
      >
        ...
        <div style={{ display: "flex", gap: 0, flex: "0 0 auto" }}>
          ...
          <div
            style={{
              ...
              justifyContent: "center",
              background: "var(--d-conf-soft)",
              borderTop: "1px solid rgba(215,70,60,.2)",
              borderBottom: "1px solid rgba(215,70,60,.2)",
            }}
          >
            <div
              style={{
        ...
        >
          ...
          <div style={{ display: "flex", gap: 10 }}>
            {[
              {
                label: "15. Mai · Mail Berger",
                hint: "jüngere Quelle, direkter Absender",
                sel: true,
              },
              {
                label: "1. Juni · Steering-Protokoll",
                hint: "formell, Steering-Beschluss",
                sel: false,
              },
              ...
              >
                <span
                  style={{
                    fontSize: 13.5,
                    color: o.sel ? "var(--d-warn)" : "var(--d-ink-2)",
                    fontWeight: 450,
                  }}
                >
                  {o.label}
...
function SceneFaktGap() {
  return (
    <div className="dlg2-root">
      ...
      />
      <div
        style={{ flex: 1, padding: "36px 56px 0", display: "flex", gap: 20, overflow: "hidden" }}
      >
        {/* Links: Kontext */}
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            ...
            >
              Das Caching-Layer-Design setzt ein Latenzziel voraus. Ohne diesen Wert ist die
              Architekturentscheidung nicht treffbar.
            </div>
            <div
              style={{
                marginTop: 14,
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            ...
            >
              <input
                readOnly
                value="< 200 ms für 95% der Requests"
                style={{
                  flex: 1,
                  background: "transparent",
                  border: "none",
