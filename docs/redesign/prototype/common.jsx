...
const Ic = {
  ...
  link: () => (
    <svg
      ...
      strokeLinecap="round"
    >
      <path d="M10 14a4 4 0 0 0 5.7 0l3.5-3.5a4 4 0 0 0-5.7-5.7L11 7" />
      <path d="M14 10a4 4 0 0 0-5.7 0L4.8 13.5a4 4 0 0 0 5.7 5.7L13 17" />
    </svg>
  ),
  cmd: () => (
    <svg
      ...
      strokeLinecap="round"
    >
      <path d="M9 6H6.5A2.5 2.5 0 1 0 9 8.5V15a2.5 2.5 0 1 1-2.5-2.5H9M15 18h2.5a2.5 2.5 0 1 0-2.5-2.5V9a2.5 2.5 0 1 1 2.5 2.5H15M9 9h6v6H9z" />
    </svg>
  ),
  conflict: () => (
    <svg
  ...
  manuell: () => (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="m4 20 5-2 11-11-3-3L6 15l-2 5z" />
    </svg>
  ),
  dotsV: () => (
