...
- **Stufe 5 — Feedback-Schleife minimal schließen.** Resolver liest `entity_link_rejections` → schlägt denselben Falsch-Match nicht erneut vor. Akzeptierte Aliasse wachsen → deterministische Auflösung wird besser. Leichter als L1 (kein Prompt-Lernen — das bleibt zurückgestellt).
