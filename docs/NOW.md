...
Reihenfolge: **S0 (Beleg, vorgezogen)** → S1 → S2 (billig, sofort sichtbar) → S3 → S4 → S5 (inkl. Reject-Signal) → S6 → S7 (Status, spätere Stufe). Owner-Entscheidungen 2026-06-03: generische `entities`-Tabelle · Graphiti-Resolution mit lokalem Guard · **Beleg via Segment-Referenz · abgeleiteter Fakt-Status · Reject als Negativ-Signal mit Grund** (siehe `DECISIONS.md`).
